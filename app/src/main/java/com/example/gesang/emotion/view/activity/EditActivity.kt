...
//                    Log.e("requestPermission", "111")
//                    ActivityCompat.requestPermissions(this, arrayOf(str), perType)
//                }
//            }
//            f
//        }
...
////        Log.e("titlep:","$dataList[position].title")
////        Log.e("contentp:","$dataList[position].content")
//        editTitle.text = Editable.Factory().newEditable(dataList[position].title)
//        editTextContent.text = Editable.Factory().newEditable(dataList[position].content)
...
//                        //val bitmp = handleImage(this,data)
//                    }else {
//
//                    }
//                }
...
//        mPlayer = MediaPlayer()
//        try {
//            mPlayer!!.setDataSource(kv.decodeString("temporaryRecorderFileName"))
//            mPlayer!!.prepare()
//            //播放动画
